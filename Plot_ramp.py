...
folder_path = '/home/zihan/PX4-Autopilot/integrationtests/python_src/px4_it/mavros/path_velocity_record/ramp_0_v2/'
all_data = []
for i in range(7):
    filename = folder_path+'iris'+str(i)+'.txt'
    data_list = np.loadtxt(filename)
...
crop_data = 800
# Extract X coordinates from the data
x_coords = xyz_data[crop_data:, 0]
y_coords = xyz_data[crop_data:, 1]
z_coords = xyz_data[crop_data:, 2]
wamv_x_coords = wamv_xyz_data[crop_data:, 0]
wamv_y_coords = wamv_xyz_data[crop_data:, 1]
wamv_z_coords = wamv_xyz_data[crop_data:, 2]
############
...
#==========================================================
print("============================= Read Ramp 1 ======================")
folder_path = '/home/zihan/PX4-Autopilot/integrationtests/python_src/px4_it/mavros/path_velocity_record/ramp_1_v6/'
all_data = []
for i in range(7):
    filename = folder_path+'iris'+str(i)+'.txt'
    data_list = np.loadtxt(filename)
...
# Set labels for the axis
# plt.xlabel('Time [second]')
plt.ylabel('Angle [degree] - With 2.15 Sec Ramp')
plt.ylim(-25, 30)  # Adjust the range as needed
# Set plot title
# plt.title('Orientation')
plt.legend()
...
#==========================================================
print("============================= Read Ramp 2 ======================")
folder_path = '/home/zihan/PX4-Autopilot/integrationtests/python_src/px4_it/mavros/path_velocity_record/ramp_2/'
all_data = []
for i in range(7):
    filename = folder_path+'iris'+str(i)+'.txt'
    data_list = np.loadtxt(filename)
...
# Set labels for the axis
plt.xlabel('Time [second]')
plt.ylabel('Angle [degree] - With 6 Sec Ramp')
plt.ylim(-25, 30)  # Adjust the range as needed
# Set plot title
# plt.title('Orientation')
# plt.legend()
...
point_to_highlight_x = 15.4 # x-coordinate of the point to highlight
point_to_highlight_y = -22.7 # y-coordinate of the point to highlight
...
plt.ylim(-25, 30)  # Adjust the range as needed
# Set plot title
plt.title('With 6 Sec Ramp')
# plt.legend()




point_to_highlight_x = 22.7 # x-coordinate of the point to highlight
point_to_highlight_y = 28.15 # y-coordinate of the point to highlight
# plt.scatter(point_to_highlight_x, point_to_highlight_y, color='y', marker='o')
